                                ...
                                <div class="section-container fl-wrap">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <h3 class="bold-title">Formulir Permohonan Doa</h3>
                                            <form>
                                                <p class="form-group">
                                                ...
                                                <p class="form-group">
                                                    <label for="komsel">Komsel <b>*</b></label><br>
                                                ...
                                                <p class="form-group">
                                                    <label for="keterangan">Permintaan Doa <b>*</b></label><br>
...
<script>
    function Send() {
        ...
        if(pesan == ''){
            ...
            $.ajax({
                url: "pages/care/simpan_permohonandoa.php",
                type: "POST",
                cache: false,
                data: FormData,
                dataType:'json',
                ...
                success: function(data){
                    ...
                    if(data.status == 1)
                    {
                        Swal.fire({
                            ...
                            window.location.href="index.php?p=permohonandoa";
                        })
                    }
                    else 
                    {

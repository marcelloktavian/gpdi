...
$sql_query = "select a.nama_user, count(a.id_user) as cntUser, b.nama_level from ad_user a left join ad_level b on b.id_level = a.id_level where a.username='".$username."' and a.password='".$password."' and a.deleted=0";

...
$nama_add_pastors = mysqli_real_escape_string($koneksi,$_POST['nama_add_pastors']);
$craeted_by = mysqli_real_escape_string($koneksi,$_POST['id_user']);
echo $nama_add_pastors."<br>";
...
$name_image1 = $craeted_by.'-'.$nama_add_pastors.'.'.$imageFileType;
...
if ($uploadOk == 0) {
  ...
  $name_image1 = '0.jpg';
    ...
    $stmt1 = $koneksi->prepare("INSERT INTO `wb_pastors` (nama_pastors, photos_pastors, created_at, created_by)
    VALUES(?, ?, ?, ?)");
    $stmt1->bind_param("ssss", $nama_add_pastors, $name_image1, $tanggal_now, $craeted_by);
